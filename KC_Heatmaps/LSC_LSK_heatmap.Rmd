...
setwd("/Users/chuk/Documents/MSI2-hyperTRIBE/Fig3F_LSC_LSK_heatmaps/")
...
setwd("/Users/chuk/Documents/MSI2-hyperTRIBE/Fig3F_LSC_LSK_heatmaps/")
diu_gene.list <- read.csv("data/lsk_lsc_0.6frq_5fpkm_OCS_fpkm_adjEditSites_analysis_final_data_for_the_manuscript_numedit_frq.csv")
...
LSC and LSK DESeq2 results contain all of Diu's genes in the gene list, so no need to subset Diu's gene list any further.
...
setwd("/Users/chuk/Documents/MSI2-hyperTRIBE/Fig3F_LSC_LSK_heatmaps/figures/")

pdf("LSK_LSC_gene_expression_heatmap.pdf", 10, 14)
...
# Heatmaps
pdf("figures/LSK_LSC_edit_frequency_heatmap.pdf", 10, 14)
...
pdf("figures/LSK_LSC_edit_site_heatmap.pdf", 10, 14)

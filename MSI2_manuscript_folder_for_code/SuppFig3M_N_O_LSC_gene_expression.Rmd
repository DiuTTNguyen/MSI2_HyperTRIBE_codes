...
reads <- readRDS("/Users/karen/mount/chuk/data_resources/LSC_rnaseq_read_count_entrez_id.rds")

data.name <- "LSC_MIG_vs_DCD"
name.type <- "MIG|DCD"
...
write.csv(as.data.frame(reads.filtered.with.genesymbols), paste0(folder, data.name, "_", "_DESeq2Results.csv"))
```
